                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive m-b-40 tableFixHead">
                                    <select class="form-control col-md-3" id="homepaginator" name="homepaginator">
                                     ...
                                     <table class="table table-borderless table-data3"  id="dashboard-table">
                                        <thead>
                                            <tr>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-1 m-b-35">Top users for the month of <?php echo date('F Y');?></h3>
